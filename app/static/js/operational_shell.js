(() => {
    ...
    const drawerToggle = document.querySelector("[data-operational-mobile-menu-toggle]");
    ...
    const updateHeader = () => {
        ticking = false;
        if (body.classList.contains("operational-mobile-menu-open") || window.innerWidth > 900) return;
