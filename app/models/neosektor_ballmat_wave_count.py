...
class NeoSektorBallmatWaveCount(db.Model):
    __tablename__ = "neosektor_ballmat_wave_counts"
    __table_args__ = (
        db.UniqueConstraint(
            "sort_state_id",
            "side",
            "wave_name",
            name="uq_neosektor_ballmat_wave_counts_sort_side_wave",
        ),
    )
    ...
    sort_state = db.relationship("NeoSektorSortState", backref="ballmat_wave_counts")
