...
class Config:
    ...
    STATIC_ASSET_VERSION = os.getenv("STATIC_ASSET_VERSION", "20260924-neoscorpion-scroll-tail-state")
    ...
    GOOGLE_MOTHERBRAIN_IMPORT_ENABLED = env_flag(
        "GOOGLE_MOTHERBRAIN_IMPORT_ENABLED",
        False,
    )
    GOOGLE_MOTHERBRAIN_IMPORT_TOKEN = os.getenv("GOOGLE_MOTHERBRAIN_IMPORT_TOKEN")
    GOOGLE_MOTHERBRAIN_READER_ENABLED = env_flag(
    ...
    GOOGLE_SHEETS_REQUEST_TIMEOUT_SECONDS = os.getenv("GOOGLE_SHEETS_REQUEST_TIMEOUT_SECONDS", "5")
    GOOGLE_MOTHERBRAIN_SPREADSHEET_ID = os.getenv(
        "GOOGLE_MOTHERBRAIN_SPREADSHEET_ID",
        "10Il5VRW-O3-T9RhrVPvvDphUh03vD-heMbqJwxxmyDg",
    )
    GOOGLE_MOTHERBRAIN_MAX_REQUEST_BYTES = int(
        os.getenv("GOOGLE_MOTHERBRAIN_MAX_REQUEST_BYTES", "524288")
    )
