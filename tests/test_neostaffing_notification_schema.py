...
class NeoStaffingNotificationSchemaTest(unittest.TestCase):
    ...
    def test_factory_does_not_invoke_targeted_notification_table_ensure(self):
        assert_factory_leaves_schema_to_bootstrap(
            self, "app.services.neostaffing_notification_schema.ensure_neostaffing_notification_table"
        )
