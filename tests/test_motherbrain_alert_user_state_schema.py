...
class MotherBrainAlertUserStateSchemaTest(unittest.TestCase):
    ...
    def test_factory_does_not_invoke_targeted_startup_ensure(self):
        assert_factory_leaves_schema_to_bootstrap(
            self, "app.services.motherbrain_alert_user_state_schema.ensure_motherbrain_alert_user_state_table"
        )
