...
class NeoStaffingChangeRequestSchemaTest(unittest.TestCase):
    ...
    def test_factory_does_not_invoke_targeted_change_request_table_ensure(self):
        assert_factory_leaves_schema_to_bootstrap(
            self, "app.services.neostaffing_change_request_schema.ensure_neostaffing_change_request_tables"
        )
