...
class LocalLaunchNavigationTest(unittest.TestCase):
    ...
    def test_base_css_uses_cyber_topbar_without_vertical_grid_background(self):
        ...
        self.assertIn("grid-template-columns: repeat(5, minmax(132px, 1fr));", css)
    ...
    def test_service_worker_is_conservative_and_uses_current_logo_assets(self):
        ...
        self.assertIn('CACHE_PREFIX = "neogateway-static-"', service_worker)
        self.assertIn("neogateway-static-v20260611-2", service_worker)
        self.assertIn("/static/css/base.css?v=20260611-2", service_worker)
