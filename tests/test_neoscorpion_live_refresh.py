...
class NeoScorpionLiveRefreshTest(unittest.TestCase):
    ...
    def test_dispatch_hooks_dirty_banner_and_effective_interval_render(self):
        ...
        self.assertIn("neoscorpion-dispatch-restoring", body)
        self.assertIn('window.history.scrollRestoration = "manual"', body)
        self.assertIn('classList.remove("neoscorpion-dispatch-restoring")', script)
