...
class NeoErmacRoutesTest(unittest.TestCase):
    ...
    def test_view_outbound_renders_summary_and_door_actuals(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(b'data-neoermac-outbound-layout="compact"', response.data)
        self.assertIn(b"data-neoermac-outbound-row", response.data)
        self.assertIn(b"data-neoermac-outbound-pull-grid", response.data)
        self.assertIn(b"SDF", response.data)
        ...
        self.assertIn(b"PURE WINDOW", response.data)
        self.assertIn(b"PURE ACT", response.data)
        self.assertIn(b"1MIX PLAN", response.data)
        self.assertIn(b"1MIX WINDOW", response.data)
        self.assertIn(b"1MIX ACT", response.data)
        self.assertIn(b"2MIX PLAN", response.data)
        self.assertIn(b"2MIX WINDOW", response.data)
        self.assertIn(b"2MIX ACT", response.data)
        self.assertLess(response.data.index(b"PURE PLAN"), response.data.index(b"PURE WINDOW"))
        self.assertLess(response.data.index(b"1MIX PLAN"), response.data.index(b"1MIX WINDOW"))
        self.assertIn(b"01:20", response.data)
        self.assertIn(b"01:40", response.data)
