...
class NeoErmacRoutesTest(unittest.TestCase):
    ...
    def test_building_lineup_page_renders_belt_map(self):
        ...
        self.assertIn(b"BELT SECTION", response.data)
        ...
        self.assertIn(b"NORTH BELT", response.data)
        self.assertIn(b"SOUTH BELT", response.data)
        self.assertIn(b"EAST SIDE", response.data)
        self.assertIn(b"WEST SIDE", response.data)
